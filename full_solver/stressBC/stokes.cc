...
namespace Step22
{
    ...
    namespace data
    {
        ...
        const double topstress = -0.1;
        const double botstress = 0.1;
                               ...
                               const unsigned int component) const
    {
		if (component == 0)
			...
			return (1.0-data::phi)*(data::rhof);
		else if (component == dim)
			return (1.0-data::phi)*(-0.5);
//		if (component == 0)
            	  ...
            	  for (unsigned int q_point=0; q_point<n_face_q_points; ++q_point)
            	      {
            	        for (unsigned int i=0; i<dofs_per_cell; ++i)
            	          ...
            	          local_rhs(i) += -1.5*(fe_face_values.normal_vector(q_point) *
