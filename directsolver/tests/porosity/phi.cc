...
namespace Step9
{
                               ...
                               const unsigned int  component) const
    {
        ...
        return p[0]*p[1]*std::exp(-p[1]) + p[0]*(p[0]*p[0]+p[1]*p[1])*std::exp(-p[1]) + 1;
    }
    template <int dim>
    void
    ...
    AdvectionProblem<dim>::assemble_system ()
    {
        ...
        QGauss<dim>  quadrature_formula(data::degree+1);
...
int main ()
{
    try
    {
        ...
        for (Step9::data::degree = 1; Step9::data::degree<=3; Step9::data::degree++)
        {
